    ...
    <div className="min-h-screen bg-gray-50 p-6 flex justify-center items-center">
      <div className="w-full max-w-5xl bg-white rounded-2xl shadow-md p-8 border border-gray-100">
        ...
        <div className="flex justify-between items-center mb-8 relative">
          <h1 className="text-lg font-semibold text-gray-700">Transaction Trends</h1>
        ...
        <div className="mb-8 flex gap-10">
          <p className="text-sm text-gray-500 mb-2">Total Trends</p>
          <div className="flex items-baseline gap-3">
            <span className=" text-gray-900 font-bold">23.33</span>
            ...
            return (
              <div key={index} className="flex flex-col items-center gap-1 flex-1 min-w-[40px]">
                ...
                <div className="flex items-end justify-center h-40 w-full gap-1">
                  ...
                  {item.positive > 0 && (
                    <div
                      className="bg-blue-800 rounded-sm transition-all hover:opacity-80"
                      style={{
                  ...
                  {item.negative > 0 && (
                    <div
                      className="bg-orange-400 rounded-sm transition-all hover:opacity-80"
                      style={{
