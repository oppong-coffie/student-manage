...
export default function AnalyticsCharts() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-7 gap-6 mt-6">
      ...
      <div style={{ display: "flex", alignItems: "center", marginBottom: "16px" }}>
            <div style={{ width: "6px", height: "22px", background: "gray", borderRadius: "0px 6px 6px 0px", marginRight: "8px" }}></div>
            <h3 style={{ margin: 0, fontWeight: "bold" }}>Sales and Redemption Trends</h3>
        </div>
  ...
  <AreaChart data={revenueData} margin={{ top: 10, right: 3, left: 0, bottom: 0 }}>
    ...
    />
      ...
      <div style={{ display: "flex", alignItems: "center", marginBottom: "16px" }}>
            <div style={{ width: "6px", height: "22px", background: "gray", borderRadius: "0px 6px 6px 0px", marginRight: "8px" }}></div>
            <h3 style={{ margin: 0, fontWeight: "bold" }}>Top 3 Performing Offer</h3>
          </div>
